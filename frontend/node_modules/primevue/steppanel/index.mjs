...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.isVertical ? (openBlock(), createElementBlock(Fragment, {
    ...
    key: 0
  }, [$options.active ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
    key: 0,
    id: $options.id,
    "class": _ctx.cx('root'),
    role: "tabpanel",
    ...
    _: 3
  }, 16, ["id", "class", "aria-controls"])) : createCommentVNode("", true)], 64)) : _ctx.asChild && $options.active ? renderSlot(_ctx.$slots, "default", {
    key: 1,
    active: $options.active,
    a11yAttrs: $options.a11yAttrs,
    activateCallback: function activateCallback(val) {
