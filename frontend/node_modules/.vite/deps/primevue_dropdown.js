...
function resolveFieldData(data4, field) {
  if (!data4 || !field) {
    return null;
  }
  try {
    const value = data4[field];
...
function EventBus() {
  ...
  return {
    on(type, handler4) {
      ...
      if (!handlers) handlers = [handler4];
      else handlers.push(handler4);
...
var dtwt = (theme13 = {}, tokenPath, fallback, type = "variable") => {
  if (tokenPath) {
...
var script = {
  ...
  methods: {
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
      ...
      var scopedStyle = (_this$$style11 = this.$style) === null || _this$$style11 === void 0 ? void 0 : _this$$style11.load(css4, _objectSpread3({
    ...
    _getPTDatasets: function _getPTDatasets() {
      ...
      return key !== "transition" && _objectSpread3(_objectSpread3({}, key === "root" && _objectSpread3(_defineProperty4({}, "".concat(datasetPrefix, "name"), toFlatCase(isExtended ? (_this$pt5 = this.pt) === null || _this$pt5 === void 0 ? void 0 : _this$pt5["data-pc-section"] : this.$.type.name)), isExtended && _defineProperty4({}, "".concat(datasetPrefix, "extend"), toFlatCase(this.$.type.name)))), {}, _defineProperty4({}, "".concat(datasetPrefix, "section"), toFlatCase(key)));
    },
...
var BaseDirective = {
  ...
  _loadScopedThemeStyles: function _loadScopedThemeStyles2() {
    ...
    if (preset && instance.$attrSelector) {
      ...
      var scopedStyle = (_instance$$style12 = instance.$style) === null || _instance$$style12 === void 0 ? void 0 : _instance$$style12.load(css4, _objectSpread5({
  ...
  _mergeProps: function _mergeProps2() {
    ...
    return isFunction2(fn) ? fn.apply(void 0, args) : mergeProps.apply(void 0, args);
  },
  _extend: function _extend(name) {
    ...
    var handleHook = function handleHook2(hook, el, binding, vnode, prevVnode) {
      ...
      el.$pd || (el.$pd = {});
      el.$pd[name] = _objectSpread5(_objectSpread5({}, (_el$$pd = el.$pd) === null || _el$$pd === void 0 ? void 0 : _el$$pd[name]), {}, {
        name,
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread7(_objectSpread7({}, group), {}, _defineProperty9({}, typeof _this15.optionGroupChildren === "string" ? _this15.optionGroupChildren : "items", _toConsumableArray3(filteredItems))));
          });
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("label")), null, 16, _hoisted_27)) : (openBlock(), createElementBlock("span", mergeProps({
    key: 1,
    ref: "focusInput",
    id: _ctx.labelId || _ctx.inputId,
    "class": [_ctx.cx("label"), _ctx.inputClass, _ctx.labelClass],
